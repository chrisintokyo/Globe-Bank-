<?php 
$pages = [
['id' => '1', 'position' => '1', 'visible' => 'menu_name' => 'Globe Bank'],
...
<?php foreach($pages as $page) {?>
  ...
  <tr>
    ...
    <td><a class="action" href="<?php echo url_for('/staff/pages/show.php?id=' . h(u($page['id']))); 
    ?>">View</a></td>

    <td><a class="action" href="">Edit</a></td>
    <td><a class="action" href="">Delete</a>
</tr>
